...
summary: '设置好SolidFire系统后，您可能需要执行一些可选任务。此外，您还可以配置多因素身份验证、外部密钥管理和联邦信息处理标准 (FIPS) 安全性的设置。' 
---
= 部署后配置SolidFire系统选项
:allow-uri-read: 
:icons: font
...
* link:task_post_deploy_credentials.html["更改NetApp HCI和NetApp SolidFire中的凭据"]
