...
summary: SolidFire系统使用卷来配置存储。卷是可通过网络由 iSCSI 或光纤通道客户端访问的块设备。在“管理”选项卡的“卷”页面上，您可以创建、修改、克隆和删除节点上的卷。您还可以查看有关卷带宽和 I/O 使用情况的统计信息。 
---
= 使用卷
:allow-uri-read: 
:icons: font
...
* link:concept_data_manage_volumes_quality_of_service_policies.html["管理服务质量政策"]
* link:task_data_manage_volumes.html#create-a-volume["创建卷"]
* link:task_data_manage_volumes.html#view-volume-details["查看各销量表现详情"]
* link:task_data_manage_volumes.html#edit-active-volumes["编辑活动卷"]
* link:task_data_manage_volumes.html#delete-a-volume["删除卷"]
* link:task_data_manage_volumes.html#restore-a-deleted-volume["恢复已删除的卷"]
...
* link:task_data_manage_volumes_apply_a_qos_policy.html["对卷应用QoS策略"]
