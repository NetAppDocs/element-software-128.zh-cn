...
summary: 您可以使用 ListBulkVolumeJobs 方法获取有关系统中正在发生的每个批量卷读取或写入操作的信息。 
---
= 批量作业列表
:allow-uri-read: 
:icons: font
...
[role="lead"]
你可以使用 `ListBulkVolumeJobs`获取系统中正在发生的每个大容量卷读取或写入操作的信息的方法。
...
每个大批量作业的信息数组。
 a| 
xref:reference_element_api_bulkvolumejob.adoc[批量作业]大批
